...
const routes = [
    ...
    {
        path: 'glosario',
        loadChildren: () => Promise.all(/*! import() | glosario-glosario-module */[__webpack_require__.e("default~detail-detail-module~glosario-glosario-module"), __webpack_require__.e("glosario-glosario-module")]).then(__webpack_require__.bind(null, /*! ./glosario/glosario.module */ "./src/app/glosario/glosario.module.ts")).then(m => m.GlosarioPageModule)
    },
    {
        path: 'detail/:palabra',
        loadChildren: () => Promise.all(/*! import() | detail-detail-module */[__webpack_require__.e("default~detail-detail-module~glosario-glosario-module"), __webpack_require__.e("detail-detail-module")]).then(__webpack_require__.bind(null, /*! ./detail/detail.module */ "./src/app/detail/detail.module.ts")).then(m => m.DetailPageModule)
    },
    {
        path: 'caracteristicas/:ante',
        loadChildren: () => __webpack_require__.e(/*! import() | caracteristicas-caracteristicas-module */ "caracteristicas-caracteristicas-module").then(__webpack_require__.bind(null, /*! ./caracteristicas/caracteristicas.module */ "./src/app/caracteristicas/caracteristicas.module.ts")).then(m => m.CaracteristicasPageModule)
    },
    {
        path: 'genero/:genero',
        loadChildren: () => __webpack_require__.e(/*! import() | genero-genero-module */ "genero-genero-module").then(__webpack_require__.bind(null, /*! ./genero/genero.module */ "./src/app/genero/genero.module.ts")).then(m => m.GeneroPageModule)
    },
];
...
let FiltroPipe = class FiltroPipe {
    transform(arreglo, texto) {
        ...
        return arreglo.filter(item => item.palabra.toLowerCase().includes(texto));
    }
};
...
module.exports = __webpack_require__(/*! /home/joel/proyectos/ionic/ctm/src/main.ts */"./src/main.ts");
