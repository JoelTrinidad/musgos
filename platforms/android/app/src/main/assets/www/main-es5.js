...
var routes = [
    ...
    {
        path: 'glosario',
        loadChildren: function () { return Promise.all(/*! import() | glosario-glosario-module */[__webpack_require__.e("default~detail-detail-module~glosario-glosario-module"), __webpack_require__.e("glosario-glosario-module")]).then(__webpack_require__.bind(null, /*! ./glosario/glosario.module */ "./src/app/glosario/glosario.module.ts")).then(function (m) { return m.GlosarioPageModule; }); }
    },
    {
        path: 'detail/:palabra',
        loadChildren: function () { return Promise.all(/*! import() | detail-detail-module */[__webpack_require__.e("default~detail-detail-module~glosario-glosario-module"), __webpack_require__.e("detail-detail-module")]).then(__webpack_require__.bind(null, /*! ./detail/detail.module */ "./src/app/detail/detail.module.ts")).then(function (m) { return m.DetailPageModule; }); }
    },
    {
        path: 'caracteristicas/:ante',
        loadChildren: function () { return __webpack_require__.e(/*! import() | caracteristicas-caracteristicas-module */ "caracteristicas-caracteristicas-module").then(__webpack_require__.bind(null, /*! ./caracteristicas/caracteristicas.module */ "./src/app/caracteristicas/caracteristicas.module.ts")).then(function (m) { return m.CaracteristicasPageModule; }); }
    },
    {
        path: 'genero/:genero',
        loadChildren: function () { return __webpack_require__.e(/*! import() | genero-genero-module */ "genero-genero-module").then(__webpack_require__.bind(null, /*! ./genero/genero.module */ "./src/app/genero/genero.module.ts")).then(function (m) { return m.GeneroPageModule; }); }
    },
];
...
var FiltroPipe = /** @class */ (function () {
    ...
    FiltroPipe.prototype.transform = function (arreglo, texto) {
        ...
        return arreglo.filter(function (item) {
            return item.palabra.toLowerCase().includes(texto);
        });
    };
