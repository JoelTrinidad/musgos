...
var CaracteristicasPageRoutingModule = /** @class */ (function () {
    function CaracteristicasPageRoutingModule() {
    }
    ...
    return CaracteristicasPageRoutingModule;
}());
...
var CaracteristicasPageModule = /** @class */ (function () {
    function CaracteristicasPageModule() {
    }
    ...
    return CaracteristicasPageModule;
}());
...
var CaracteristicasPage = /** @class */ (function () {
    function CaracteristicasPage(navCtr, route, mus) {
        var _this = this;
        this.navCtr = navCtr;
        this.route = route;
        this.mus = mus;
        ...
        this.musgos = this.mus.musgos.filter(function (musgo) { return musgo.antecesor == _this.ante; });
    }
    CaracteristicasPage.prototype.ngOnInit = function () {
        console.log(this.musgos);
    };
    CaracteristicasPage.prototype.goTo = function (genero, ante) {
        if (genero != "") {
    ...
    CaracteristicasPage.prototype.goToGlosarioPage = function () {
        this.navCtr.navigateForward("glosario");
    };
    CaracteristicasPage.ctorParameters = function () { return [
...
var MusgosService = /** @class */ (function () {
    function MusgosService() {
        this.musgos = [
            {
                id: "1",
                clave: "1",
...
//# sourceMappingURL=caracteristicas-caracteristicas-module-es5.js.map