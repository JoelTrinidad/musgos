...
var GeneroPageRoutingModule = /** @class */ (function () {
    function GeneroPageRoutingModule() {
    }
    ...
    return GeneroPageRoutingModule;
}());
...
var GeneroPage = /** @class */ (function () {
    function GeneroPage(route, gen) {
        var _this = this;
        this.route = route;
        this.gen = gen;
        this.genero = this.route.snapshot.paramMap.get('genero');
        this.generos = this.gen.generos.filter(function (x) { return x.nombre == _this.genero; });
    }
    GeneroPage.prototype.ngOnInit = function () {
    };
    GeneroPage.ctorParameters = function () { return [
...
//# sourceMappingURL=genero-genero-module-es5.js.map